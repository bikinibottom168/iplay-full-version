...
<link href="{{asset('admin/assets/css/dashboard/dash_1.css')}}" rel="stylesheet" type="text/css" />
    ...
    @case('contacts')
      ...
      <link href="{{asset('admin/plugins/jquery-ui/jquery-ui.min.css')}}" rel="stylesheet" type="text/css" />
    ...
    @case('mailbox')
      ...
      <link href="{{asset('admin/assets/css/apps/mailbox.css')}}" rel="stylesheet" type="text/css" />
    ...
    @case('notes')
      {{-- App Notes --}}
      <link href="{{asset('admin/assets/css/apps/notes.css')}}" rel="stylesheet" type="text/css" />
      <link href="{{asset('admin/assets/css/forms/theme-checkbox-radio.css')}}" rel="stylesheet" type="text/css" />
      @break
    
    @case('scrumboard')
      {{-- App Scrumboard --}}
      <link href="{{asset('admin/assets/css/apps/scrumboard.css')}}" rel="stylesheet" type="text/css" />
      <link href="{{asset('admin/assets/css/forms/theme-checkbox-radio.css')}}" rel="stylesheet" type="text/css">
      @break
    ...
    @case('todo-list')
      {{-- App Todo List --}}
      <link rel="stylesheet" type="text/css" href="{{asset('admin/plugins/editors/quill/quill.snow.css')}}">
      <link href="{{asset('admin/assets/css/apps/todolist.css')}}" rel="stylesheet" type="text/css" />
      @break
    ...
    @case('countdown')
      {{-- Compoents Countdown --}}
      <link href="{{asset('admin/assets/css/scrollspyNav.css')}}" rel="stylesheet" type="text/css" />
      <link href="{{asset('admin/assets/css/components/custom-countdown.css')}}" rel="stylesheet" type="text/css">
      @break
    ...
    @case('pricing_table')
      ...
      <link rel="stylesheet" type="text/css" href="{{asset('admin/assets/css/forms/switches.css')}}">
      <link href="{{asset('admin/plugins/pricing-table/css/component.css')}}" rel="stylesheet" type="text/css" />
      @break
    ...
    @case('timeline')
      {{-- Component Timeline --}}
      <link href="{{asset('admin/assets/css/scrollspyNav.css')}}" rel="stylesheet" type="text/css" />
      <link href="{{asset('admin/assets/css/components/timeline/custom-timeline.css')}}" rel="stylesheet" type="text/css" />
      <style>
    ...
    @case('drag_n_drop')
      ...
      <link href="{{asset('admin/plugins/drag-and-drop/dragula/example.css')}}" rel="stylesheet" type="text/css" />
      @break
    ...
    @case('badges')
      {{-- Elements Badges --}}
      <link href="{{asset('admin/plugins/tagInput/tags-input.css')}}" rel="stylesheet" type="text/css" />
      <style>
    ...
    @case('loaders')
      {{-- Elements Loader  --}}
      <link href="{{asset('admin/plugins/loaders/custom-loader.css')}}" rel="stylesheet" type="text/css" />
      @break
    ...
    @case('popovers')
      {{-- Elements Popovers --}}
      <link href="{{asset('admin/assets/css/elements/popover.css')}}" rel="stylesheet" type="text/css" />
      @break
    ...
    @case('treeview')
      {{-- Elements Tree View --}}
      <link href="{{asset('admin/assets/css/elements/custom-tree_view.css')}}" rel="stylesheet" type="text/css" />
      @break

    @case('typography')
      {{-- Elements Typography --}}
      <link href="{{asset('admin/assets/css/elements/custom-typography.css')}}" rel="stylesheet" type="text/css" />
      @break
    ...
    @case('maps')
      {{-- Maps --}}
      <link href="{{asset('admin/assets/css/scrollspyNav.css')}}" rel="stylesheet" type="text/css" />
      <link href="{{asset('admin/plugins/jvector/jquery-jvectormap-2.0.3.css')}}" rel="stylesheet" type="text/css" />
      <style>
    ...
    @case('contact_us')
      {{-- Pages Contact Us --}}
      <link href="{{asset('admin/assets/css/plugins.css')}}" rel="stylesheet" type="text/css" />
      <link href="{{asset('admin/assets/css/pages/contact_us.css')}}" rel="stylesheet" type="text/css" />
      <link rel="stylesheet" type="text/css" href="{{asset('admin/assets/css/forms/theme-checkbox-radio.css')}}">
      <style>
        #content {
            width: 100%;
    ...
    @case('error503')
      {{-- Pages Error 503 --}}
      <link href="{{asset('admin/assets/css/plugins.css')}}" rel="stylesheet" type="text/css" />
      <link href="{{asset('admin/assets/css/pages/error/style-503.css')}}" rel="stylesheet" type="text/css" />
      <style>
        #content {
            width: 100%;
            margin-top: 0;
    ...
    @case('faq2')
      {{-- Pages Faq 2 --}}
      <link href="{{asset('admin/assets/css/pages/faq/faq2.css')}}" rel="stylesheet" type="text/css" />
      @break
    ...
    @case('maintenence')
      {{-- Pages Maintenence --}}
      <link href="{{asset('admin/assets/css/plugins.css')}}" rel="stylesheet" type="text/css" />
      <link href="{{asset('admin/assets/css/pages/error/style-maintanence.css')}}" rel="stylesheet" type="text/css" />
      <style>
        #content {
            width: 100%;
            margin-left: 0;
    ...
    @case('privacy')
      {{-- Pages Privacy --}}
      <link href="{{asset('admin/assets/css/main.css')}}" rel="stylesheet" type="text/css" />
      <link href="{{asset('admin/assets/css/pages/privacy/privacy.css')}}" rel="stylesheet" type="text/css" />
      @break
    ...
    @case('basic-light')
      ...
      <link rel="stylesheet" type="text/css" href="{{asset('admin/plugins/table/datatable/datatables-light.css')}}">
      <link rel="stylesheet" type="text/css" href="{{asset('admin/plugins/table/datatable/dt-global_style-light.css')}}">
      @break
    ...
    @case('miscellaneous')
      ...
      <link rel="stylesheet" type="text/css" href="{{asset('admin/plugins/table/datatable/datatables.css')}}">
      <link rel="stylesheet" type="text/css" href="{{asset('admin/plugins/table/datatable/custom_dt_miscellaneous.css')}}">
      <link rel="stylesheet" type="text/css" href="{{asset('admin/assets/css/forms/theme-checkbox-radio.css')}}">
      <link rel="stylesheet" type="text/css" href="{{asset('admin/plugins/table/datatable/dt-global_style.css')}}">
      @break
    ...
    @case('multiple_tables')
      ...
      <link rel="stylesheet" type="text/css" href="{{asset('admin/plugins/table/datatable/datatables.css')}}">
      <link rel="stylesheet" type="text/css" href="{{asset('admin/plugins/table/datatable/dt-global_style.css')}}">
      <link rel="stylesheet" type="text/css" href="{{asset('admin/plugins/table/datatable/custom_dt_multiple_tables.css')}}">
      @break
    ...
    @case('typeahead')
      {{-- Forms Typeahead --}}
      <link href="{{asset('admin/assets/css/scrollspyNav.css')}}" rel="stylesheet" type="text/css" />
      <link href="{{asset('admin/plugins/autocomplete/autocomplete.css')}}" rel="stylesheet" type="text/css" />
      <style>
