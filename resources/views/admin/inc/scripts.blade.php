...
@switch($page_name)
    ...
    @case('calendar')
      ...
      <script src="{{asset('admin/plugins/fullcalendar/custom-fullcalendar.advance.js')}}"></script>
      @break
    ...
    @case('mailbox')
      {{-- App Mailbox --}}
      <script src="{{asset('admin/assets/js/ie11fix/fn.fix-padStart.js')}}"></script>
      ...
      <script src="{{asset('admin/assets/js/apps/custom-mailbox.js')}}"></script>
      @break

    @case('notes')
      {{-- App Notes --}}
      <script src="{{asset('admin/assets/js/ie11fix/fn.fix-padStart.js')}}"></script>
      <script src="{{asset('admin/assets/js/apps/notes.js')}}"></script>
      @break
    ...
    @case('scrumboard')
      ...
      <script src="{{asset('admin/plugins/jquery-ui/jquery-ui.min.js')}}"></script>
      <script src="{{asset('admin/assets/js/ie11fix/fn.fix-padStart.js')}}"></script>
      <script src="{{asset('admin/assets/js/apps/scrumboard.js')}}"></script>
      @break
    ...
    @case('todo-list')
      ...
      <script src="{{asset('admin/assets/js/ie11fix/fn.fix-padStart.js')}}"></script>
      <script src="{{asset('admin/plugins/editors/quill/quill.js')}}"></script>
      <script src="{{asset('admin/assets/js/apps/todoList.js')}}"></script>  
      @break
    ...
    @case('countdown')
      ...
      <script src="{{asset('admin/assets/js/scrollspyNav.js')}}"></script>
      <script src="{{asset('admin/plugins/countdown/jquery.countdown.min.js')}}"></script>
      <script src="{{asset('admin/assets/js/components/custom-countdown.js')}}"></script>
      @break
    ...
    @case('session_timeout')
      ...
      <script src="{{asset('admin/assets/js/components/session-timeout/bootstrap-session-timeout.js')}}"></script>
      <script src="{{asset('admin/assets/js/components/session-timeout/custom-bootstrap_session_timeout.js')}}"></script>
      @break
    ...
    @case('drag_n_drop')
      ...
      <script src="{{asset('admin/plugins/drag-and-drop/dragula/custom-dragula.js')}}"></script>
      @break
    ...
    @case('popovers')
      {{-- Element popovers --}}
      <script src="{{asset('admin/assets/js/elements/popovers.js')}}"></script>
      @break
    
    @case('search')
      {{-- Elements Serach --}}
      <script src="{{asset('admin/assets/js/elements/custom-search.js')}}"></script>
      @break
    ...
    @case('treeview')
      {{-- Elements Treeview --}}
      <script src="{{asset('admin/plugins/treeview/custom-jstree.js')}}"></script>
      <script src="{{asset('admin/assets/js/scrollspyNav.js')}}"></script>
      @break
    ...
    @case('maps')
      {{-- Maps Jvector --}}
      <script src="{{asset('admin/assets/js/scrollspyNav.js')}}"></script>
      <script src="{{asset('admin/plugins/jvector/jquery-jvectormap-2.0.3.min.js')}}"></script>
      <script src="{{asset('admin/plugins/jvector/africa/jquery-jvectormap-africa-en.js')}}"></script>
      <script src="{{asset('admin/plugins/jvector/asia/jquery-jvectormap-asia-en.js')}}"></script>
      <script src="{{asset('admin/plugins/jvector/continents/jquery-jvectormap-continents-en.js')}}"></script>
      <script src="{{asset('admin/plugins/jvector/europe/jquery-jvectormap-europe-en.js')}}"></script>
      <script src="{{asset('admin/plugins/jvector/north_america/jquery-jvectormap-north-america-en.js')}}"></script>
      <script src="{{asset('admin/plugins/jvector/oceania/jquery-jvectormap-oceanina-en.js')}}"></script>
      <script src="{{asset('admin/plugins/jvector/south-america/jquery-jvectormap-south-america-en.js')}}"></script>
      <script src="{{asset('admin/plugins/jvector/worldmap_script/jquery-jvectormap-world-mill-en.js')}}"></script>
      <script src="{{asset('admin/plugins/jvector/jvector_script.js')}}"></script>
      @break
      ...
      <script>
          ...
          function initMap() {
              ...
              var marker = new google.maps.Marker({
                ...
                map: map,
                title: 'Hello World!',
                icon: "{{asset('admin/storage/img/contact-us-map-pin.svg')}}"
              });
          }
      </script>
      <script src="{{asset('admin/https://maps.googleapis.com/maps/api/js?key=AIzaSyDoOlJCERKYB1Cp-C89_sscNkelSfeeBnw&callback=initMap')}}" async defer></script>
      @break
    ...
    @case('faq2')
      {{-- Pages FAQ2 --}}
      <script src="{{asset('admin/assets/js/pages/faq/faq2.js')}}"></script>
      @break
    ...
    @case('miscellaneous')
      ...
      <script src="{{asset('admin/plugins/table/datatable/datatables.js')}}"></script>
      <script src="{{asset('admin/plugins/table/datatable/custom_miscellaneous.js')}}"></script>
      @break
    ...
    @case('clipboard')
      ...
      <script src="{{asset('admin/assets/js/forms/custom-clipboard.js')}}"></script>
      @break
    ...
    @case('typeahead')
      {{-- Forms Typeahead --}}
      <script src="{{asset('admin/assets/js/scrollspyNav.js')}}"></script>
      <script src="{{asset('admin/plugins/autocomplete/jquery.mockjax.js')}}"></script>
      <script src="{{asset('admin/plugins/autocomplete/jquery.autocomplete.js')}}"></script>
      <script src="{{asset('admin/plugins/autocomplete/countries.js')}}"></script>
      <script src="{{asset('admin/plugins/autocomplete/demo.js')}}"></script>
      @break
