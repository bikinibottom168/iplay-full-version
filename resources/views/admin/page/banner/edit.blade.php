                                                        ...
                                                        <div class="g-items">
                                                            <div class="item" data-number="0">
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-md-2">
                                                                        <input type="text" name="button_ads[0][link]" class="form-control" placeholder="" value="{{ $button_ads ? $button_ads[0]->link : "" }}">
                                                                    </div>
                                                                    <div class="col-md-2">
                                                            ...
                                                            <div class="item" data-number="1">
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-md-2">
                                                                        <input type="text" name="button_ads[1][link]" class="form-control" placeholder="" value="{{ $button_ads ? $button_ads[1]->link : "" }}">
                                                                    </div>
                                                                    <div class="col-md-2">
                                                            ...
                                                            <div class="item" data-number="2">
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-md-2">
                                                                        <input type="text" name="button_ads[2][link]" class="form-control" placeholder="" value="{{ $button_ads ? $button_ads[2]->link : "" }}">
                                                                    </div>
                                                                    <div class="col-md-2">
                                                            ...
                                                            <div class="item" data-number="3">
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-md-2">
                                                                        <input type="text" name="button_ads[3][link]" class="form-control" placeholder="" value="{{ $button_ads ? $button_ads[3]->link : "" }}">
                                                                    </div>
                                                                    <div class="col-md-2">
